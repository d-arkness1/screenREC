<div>
  //footer.sh__footer .sh__footer-wrp h2.sh__footer--text Built with&nbsp;
  picture(class="sh__footer--love-icon")
  ...
  img(src="images/heart.svg?width=80" alt="heart icon") | &nbsp;by&nbsp;
  a(href="https://twitter.com/heysagnik" class="sh__footer--user") span Sagnik
  picture(class="sh__footer--user-icon")
